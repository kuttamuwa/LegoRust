...
fn main() {
    ...
    columns.insert(SlopeColumns::DEPTH, "DERINLIK".to_string());
    columns.insert(SlopeColumns::DIP, "DALIM".to_string());
...
#[cfg(test)]
mod tests {
    use crate::{SlopeColumns, SlopeInformation, SlopeObject};
    use std::collections::HashMap;
    ...
    fn running_test() {
        ...
        columns.insert(SlopeColumns::DRILLNO, "SONDAJNO".to_string());
        columns.insert(SlopeColumns::FROM, "FROM".to_string());
        columns.insert(SlopeColumns::TO, "TO".to_string());
        columns.insert(SlopeColumns::PERCENT, "PERCENT".to_string());
